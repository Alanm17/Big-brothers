  ...
  const staffMembers = [
    {
      ...
      bio: `Isabella's culinary journey began in her grandmother's kitchen in Valencia, where she learned that food is love made visible. After training at Le Cordon Bleu Paris and working in Michelin-starred restaurants across Europe, she founded bigbro to bring authentic flavors to life while honoring traditional techniques.\n\nHer philosophy centers on respecting the natural essence of each ingredient while elevating it through careful technique and passionate presentation. Every dish at bigbro reflects her commitment to quality, sustainability, and creating memorable dining experiences.`,
      credentials: [
      ...
      social: {
        instagram: "@chef_isabella_bigbro",
    ...
    },
    {
      ...
      bio: `Marcus brings precision and creativity to bigbro's dessert program. Trained at the Culinary Institute of America, he specializes in creating desserts that perfectly complement our seasonal menus while showcasing his innovative approach to classic techniques.\n\nHis attention to detail and passion for flavor balance make him an invaluable part of our culinary team. Marcus believes that dessert should be the perfect ending to a memorable meal, leaving guests with a sweet final impression.`,
      credentials: [
      ...
      quote:
        "A great dessert doesn't just end a meal—it creates a lasting memory that brings people back.",
      social: {
        instagram: "@marcus_pastry_art",
        linkedin: "marcus-thompson-pastry",
      },
    },
    {
      id: 3,
      ...
      bio: `Sofia ensures that every guest at bigbro feels welcomed and valued. With over a decade of experience in hospitality management, she has a keen eye for detail and a genuine passion for creating exceptional dining experiences.\n\nHer leadership style focuses on empowering the front-of-house team to deliver personalized service that makes each visit special. Sofia believes that great hospitality is about anticipating needs and creating moments of delight throughout the dining experience.`,
      credentials: [
        "Hospitality Management Degree",
        "Certified Restaurant Manager",
        "Wine Service Certified",
        "Customer Experience Specialist",
      ],
      quote:
        "True hospitality is making our guests feel like they're dining in the home of a dear friend.",
      social: {
        instagram: "@sofia_bigbro_mgr",
    ...
    },
    {
      ...
      quote:
        "The perfect wine pairing doesn't just complement the dish—it creates a new experience entirely.",
      social: {
        instagram: "@james_wine_bigbro",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground font-body max-w-3xl mx-auto leading-relaxed">
            Behind every exceptional dining experience is a passionate team of
            culinary professionals and hospitality experts dedicated to creating
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="prose prose-lg max-w-none">
                  {staffMembers?.[activeProfile]?.bio
                    ?.split("\n\n")
                    ?.map((paragraph, index) => (
                      <p
                        key={index}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {staffMembers?.[activeProfile]?.credentials?.map(
                    (credential, index) => (
                      <div
                        key={index}
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {teamStats?.map((stat, index) => (
              <div
                key={index}
                className="bg-card p-6 rounded-xl shadow-subtle hover:shadow-brand transition-all duration-300 text-center group"
              >
        ...
        <div className="bg-card p-8 lg:p-12 rounded-2xl shadow-subtle">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground font-body max-w-3xl mx-auto leading-relaxed">
              At bigbro, we believe that exceptional dining experiences are
              created by passionate people who love what they do. Our team is
              united by a shared commitment to culinary excellence, genuine
              hospitality, and continuous learning.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-body">
                We invest in our team's growth through ongoing training and
                culinary education
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-body">
                Every team member contributes to creating memorable experiences
                for our guests
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-body">
                We maintain the highest standards in everything we do, from food
                to service
              </p>
            </div>
          </div>
