...
const SpecialPackages = ({ onPackageSelect }) => {
  const packages = [
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/3184183/pexels-photo-3184183.jpeg?w=400&h=300&fit=crop',
      features: [
    ...
    },
    {
      ...
      image: 'https://images.pixabay.com/photo/2016/11/18/14/05/brick-wall-1834784_1280.jpg?w=400&h=300&fit=crop',
      features: [
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Elevate your visit with our curated special experiences, designed to create lasting memories 
          through exceptional cuisine and personalized service.
        </p>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {packages?.map((pkg) => (
          <div key={pkg?.id} className="bg-card rounded-lg shadow-brand overflow-hidden group hover:shadow-xl transition-all duration-300">
            {/* Package Image */}
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute top-4 left-4">
                <div className="w-12 h-12 bg-accent rounded-lg flex items-center justify-center shadow-brand">
                  <Icon name={pkg?.icon} size={24} className="text-accent-foreground" />
                </div>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-muted-foreground">{pkg?.availability}</span>
                </div>
              </div>
      ...
      <div className="bg-accent/10 rounded-lg p-6 text-center">
        ...
        <p className="text-muted-foreground mb-4">
          Our team is happy to help you select the perfect dining experience for your occasion.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-foreground font-medium">events@savoria.com</span>
          </div>
        </div>
      </div>
    </div>
