          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Secure your spot for an unforgettable dining experience at Savoria. 
                Choose from our regular dining options or explore our special culinary experiences.
              </p>
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-center space-x-4 mb-4">
                    <div className={`
                      ...
                      ${selectedDate ? 'bg-success text-white' : 'bg-muted text-muted-foreground'}
                    `}>
                    ...
                    <div className={`
                      flex items-center space-x-2 px-3 py-1 rounded-full text-sm
                      ${selectedTime ? 'bg-success text-white' : 'bg-muted text-muted-foreground'}
                    `}>
                    ...
                    <div className={`
                      flex items-center space-x-2 px-3 py-1 rounded-full text-sm
                      ${selectedDate && selectedTime ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'}
                    `}>
          ...
          <section className="bg-primary/5 py-12">
            <div className="container mx-auto px-6 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Explore our curated dining experiences including wine pairings, chef's table, 
                and private dining options for memorable occasions.
              </p>
              <Button
                variant="default"
      ...
      <footer className="bg-foreground text-background py-8">
        <div className="container mx-auto px-6 text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-xl font-heading font-bold">Savoria</span>
          </div>
