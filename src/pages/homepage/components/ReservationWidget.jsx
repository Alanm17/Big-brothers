          ...
          <div className="space-y-8">
            <div>
              <div className="inline-flex items-center space-x-2 bg-accent/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-accent font-body font-medium">Reserve Your Table</span>
              </div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-6">
                Secure Your Culinary Experience
              </h2>
              <p className="text-lg text-muted-foreground font-body leading-relaxed mb-8">
                Book your table at Savoria and embark on a memorable dining journey. Our reservation system offers real-time availability and special dining options to enhance your experience.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-body font-semibold text-foreground">Real-time Availability</h3>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-body font-semibold text-foreground">Wine Pairings</h3>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-body font-semibold text-foreground">Premium Seating</h3>
                  <p className="text-sm text-muted-foreground">Best table options</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-body font-semibold text-foreground">Special Events</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-foreground font-body italic mb-3">
                    "The reservation process was seamless, and the dining experience exceeded all expectations. Savoria truly delivers on their promise of exceptional hospitality."
                  </p>
                  <div className="flex items-center space-x-2">
                    <span className="font-body font-semibold text-foreground">Sarah Mitchell</span>
            ...
            <div className="space-y-6">
              ...
              {reservationData?.date && (
                <div className="bg-card p-4 rounded-lg border border-border">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <Icon 
                        name={getAvailabilityForDate(reservationData?.date)?.available ? "CheckCircle" : "XCircle"} 
                        size={20} 
                        className={getAvailabilityForDate(reservationData?.date)?.available ? "text-success" : "text-error"} 
                      />
                      <span className="font-body font-medium text-foreground">
                        {getAvailabilityForDate(reservationData?.date)?.available ? "Available" : "Fully Booked"}
                      </span>
                    </div>
                    {getAvailabilityForDate(reservationData?.date)?.available && (
                      <span className="text-sm text-muted-foreground">
                        {getAvailabilityForDate(reservationData?.date)?.slots} slots remaining
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <Button
                  ...
                  iconName="Calendar"
                  iconPosition="left"
                  disabled={!reservationData?.date || !getAvailabilityForDate(reservationData?.date)?.available}
                >
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Enhance your experience with wine pairings, chef's tasting menu, or private dining options.
                    </p>
                    <Button
                      variant="ghost"
                      size="sm"
